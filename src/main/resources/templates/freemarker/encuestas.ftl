...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="/" class="logo">
            ...
            <span class="logo-lg"><b>Bar</b>Camp</span>
        </a>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active"><a href="/"><i class="fa fa-users"></i> <span>Encuestas</span></a></li>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-condensed table-hover">
                            ...
                            <tr>
                                ...
                                <td>${encuesta.cumplieronExpectativas}</td>
                                <td>${encuesta.dominioDelTema}</td>
                                <td>${encuesta.instalacionesConfortables}</td>
                                <td>${encuesta.comentario}</td>

                                <td>
                                    <a href="/mostrar/?id=${encuesta.id}">  <i class="fa fa-eye" style="font-size:25px"></i></a>
                                    <a href="/borrar/?id=${encuesta.id}"  data-toggle="modal"> <i class="fa fa-trash" style="font-size:23px;color:red"></i> </a>
                                </td>
                            </tr>
                            </#list>
                        </table>
